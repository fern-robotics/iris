...
"""
CANDLE_SPECIFIC_TYPING = "from iris.typing import _ArrayLike, Device, Scalar, Index, Shape\n"
CANDLE_TENSOR_IMPORTS = "from iris import Tensor,DType,QTensor\n"
...
if __name__ == "__main__":
    ...
    # Enable execution from the iris and iris-pyo3 directories
    cwd = Path.cwd()
    directory = "py_src/iris/"
    if cwd.name != "iris-pyo3":
        directory = f"iris-pyo3/{directory}"
    ...
    write(iris.iris, directory, "iris", check=args.check)
