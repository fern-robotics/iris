from iris.utils import load_safetensors, save_gguf, load_gguf
from iris.models.bert import BertModel, Config
import json
...
if __name__ == "__main__":
    ...
    print(f"Mean error between torch-reference and iris: {error}")
    ...
    print(f"Mean error between torch-reference and quantized-iris: {error}")
