...
use iris_onnx::eval::{dtype, get_tensor, simple_eval};
use iris_onnx::onnx::tensor_proto::DataType;
use iris_onnx::onnx::tensor_shape_proto::dimension::Value;
use iris_onnx::onnx::type_proto::{Tensor as ONNXTensor, Value as ONNXValue};
use iris_onnx::onnx::{ModelProto, ValueInfoProto};
...
impl PyONNXModel {
    ...
    fn new(path: String) -> PyResult<Self> {
        let model: ModelProto = iris_onnx::read_file(path).map_err(wrap_err)?;
