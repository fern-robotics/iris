from iris import Tensor, QTensor, DType
from typing import (
    Dict,
    Tuple,
    Any,
...
class Module:
    ...
    def state_dict(self, *args, destination=None, prefix="", keep_vars=False):
        ...
        Args:
            ...
            keep_vars (bool, optional): by default the :class:`~iris.Tensor` s
    ...
    def _save_to_state_dict(self, destination, prefix, keep_vars):
        ...
        submodule in :meth:`~iris.nn.Module.state_dict`.
    ...
    def load_state_dict(self, state_dict: Mapping[str, Any], strict: bool = True, assign: bool = False):
        ...
        by this module's :meth:`~iris.nn.Module.state_dict` function.
        ...
        Args:
            ...
            strict (bool, optional): whether to strictly enforce that the keys
                ...
                :meth:`~iris.nn.Module.state_dict` function. Default: ``True``
    ...
    def _load_from_state_dict(
        ...
        in :meth:`~iris.nn.Module.load_state_dict`. Metadata saved for this
        ...
        .. note::
            ...
            :attr:`state_dict` to :meth:`~iris.nn.Module.load_state_dict`. So
            it can be modified.
        ...
        Args:
            ...
            error_msgs (list of str): error messages should be added to this
                ...
                :meth:`~iris.nn.Module.load_state_dict`
        """
    ...
    def __cast_tensor(self, tensor: TensorLike, dtype: Union[DType, str]):
        if isinstance(tensor, Tensor):
            ...
            raise TypeError("iris.Module.to only accepts Tensor dtypes, but got desired dtype={}".format(dtype))
    ...
    def to(self, *args, **kwargs):
        ...
        Args:
            device (:class:`iris.device`): the desired device of the parameters
                and buffers in this module
            dtype (:class:`iris.dtype`): the desired floating point dtype of
        ...
        if dtype:
            ...
            if dtype not in ["f32", "f16", "f64"]:
                raise TypeError(
                    "iris.Module.to only accepts floating point" "dtypes, but got desired dtype={}".format(dtype)
                )
