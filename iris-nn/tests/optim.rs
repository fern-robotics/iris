...
use iris_core::test_utils::{to_vec0_round, to_vec2_round};

use anyhow::Result;
use iris_core::{DType, Device, Tensor, Var};
use iris_nn::{AdamW, Linear, Module, Optimizer, ParamsAdamW, SGD};
...
fn adamw_linear_regression_varmap() -> Result<()> {
    ...
    let mut var_map = iris_nn::VarMap::new();
