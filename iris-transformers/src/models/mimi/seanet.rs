...
use iris_core::{streaming, Module, Result, StreamTensor, StreamingModule, Tensor};
...
pub struct Config {
    ...
    pub activation: iris_nn::Activation,
    ...
    pub final_activation: Option<iris_nn::Activation>,
}
...
pub struct SeaNetResnetBlock {
    ...
    skip_op: iris_core::StreamingBinOp,
    span: tracing::Span,
}
...
impl SeaNetResnetBlock {
    ...
    pub fn new(
        ...
        Ok(Self {
            ...
            shortcut,
            activation,
            skip_op: streaming::StreamingBinOp::new(streaming::BinOp::Add, iris_core::D::Minus1),
...
impl SeaNetEncoder {
    pub fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        if cfg.lstm > 0 {
            iris_core::bail!("seanet lstm is not supported")
        }
...
pub struct SeaNetDecoder {
    ...
    final_conv1d: StreamableConv1d,
    final_activation: Option<iris_nn::Activation>,
    span: tracing::Span,
}
