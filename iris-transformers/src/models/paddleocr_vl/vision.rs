...
use iris_nn::{layer_norm, linear_b, LayerNorm, LayerNormConfig, Linear, Module, VarBuilder};
...
struct PatchEmbedding {
    ...
    #[allow(dead_code)]
    packing_position_embedding: iris_nn::Embedding, // Fallback, kept for weight loading
...
impl PatchEmbedding {
    fn new(cfg: &VisionConfig, vb: VarBuilder) -> Result<Self> {
        ...
        let packing_position_embedding =
            iris_nn::embedding(32768, cfg.hidden_size, vb.pp("packing_position_embedding"))?;
