use iris_core::{Result, Tensor, D};
use iris_nn::{conv2d, group_norm, Conv2d, GroupNorm, VarBuilder};
...
fn scaled_dot_product_attention(q: &Tensor, k: &Tensor, v: &Tensor) -> Result<Tensor> {
    ...
    iris_nn::ops::softmax_last_dim(&attn_weights)?.matmul(v)
}
...
impl iris_core::Module for AttnBlock {
...
impl iris_core::Module for ResnetBlock {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        let h = xs
            .apply(&self.norm1)?
            .apply(&iris_nn::Activation::Swish)?
            .apply(&self.conv1)?
            .apply(&self.norm2)?
            .apply(&iris_nn::Activation::Swish)?
            .apply(&self.conv2)?;
...
impl iris_core::Module for Downsample {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl iris_core::Module for Upsample {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl iris_nn::Module for Encoder {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl iris_nn::Module for Decoder {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl iris_nn::Module for DiagonalGaussian {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl iris_core::Module for AutoEncoder {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
