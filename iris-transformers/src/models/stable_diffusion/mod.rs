...
//!
//! <div align=center>
//!   <img src="https://github.com/huggingface/candle/raw/main/iris-examples/examples/stable-diffusion/assets/stable-diffusion-xl.jpg" alt="rusty robot holding a candle" width=320>
//! </div>
//!
...
//! # see the iris-examples/examples/stable-diffusion for all options
