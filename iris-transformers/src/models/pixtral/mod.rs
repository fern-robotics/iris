...
//!
//! <div align=center>
//!   <img src="https://github.com/huggingface/candle/raw/main/iris-examples/examples/flux/assets/flux-robot.jpg" alt="" width=320>
//! </div>
//!
//! ```bash
...
//!    --features cuda \
//!    --example pixtral -- \
//!    --image iris-examples/examples/flux/assets/flux-robot.jpg
//! ```
//!
//! ```txt
//! Describe the image.
