...
use iris_nn::{linear_b, rms_norm, Linear, RmsNorm, VarBuilder};

fn default_act() -> iris_nn::Activation {
    iris_nn::Activation::Silu
}
...
impl Config {
    pub fn pixtral_12b_2409() -> Self {
        Self {
            ...
            head_dim: None,
            // Default
            hidden_act: iris_nn::Activation::Silu,
        }
    }
...
impl RotaryEmbedding {
    ...
    fn apply_rotary_emb_qkv(
        ...
        let q_embed = iris_nn::rotary_emb::rope(q, cos, sin)?;
        let k_embed = iris_nn::rotary_emb::rope(k, cos, sin)?;
        Ok((q_embed, k_embed))
    }
}
...
impl Model {
    pub fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        ...
        let patch_conv = iris_nn::conv2d_no_bias(
            cfg.num_channels,
            cfg.hidden_size,
            cfg.patch_size,
            conv2d_cfg,
        ...
        let ln_pre = iris_nn::rms_norm(cfg.hidden_size, 1e-5, vb.pp("ln_pre"))?;
