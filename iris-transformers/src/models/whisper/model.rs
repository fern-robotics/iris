...
use iris_core::{Device, IndexOp, Result, Tensor, D};
use iris_nn::{embedding, Conv1d, Conv1dConfig, Embedding, LayerNorm, Module, VarBuilder};
...
impl MultiHeadAttention {
    ...
    fn qkv_attention(
        ...
        let w = {
            ...
            iris_nn::ops::softmax_last_dim(&qk)?
        };
        let wv = {
            let _enter = self.matmul_span.enter();
            w.matmul(&v)?
