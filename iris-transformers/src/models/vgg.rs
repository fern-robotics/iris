...
use iris_core::{ModuleT, Result, Tensor};
use iris_nn::{FuncT, VarBuilder};
...
fn fully_connected(
    ...
    let dropout1 = iris_nn::Dropout::new(0.5);
    let dropout2 = iris_nn::Dropout::new(0.5);
    let dropout3 = iris_nn::Dropout::new(0.5);
    Ok(FuncT::new(move |xs, train| {
        ...
        let lin3 = iris_nn::linear(4096, num_classes, vb.pp("head.fc"))?;
