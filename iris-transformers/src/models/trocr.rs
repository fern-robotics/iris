...
use iris_core::{DType, Result, Tensor};
use iris_nn::{
...
pub struct TrOCRConfig {
    ...
    pub activation_function: iris_nn::Activation,
...
impl Default for TrOCRConfig {
    fn default() -> Self {
        Self {
            ...
            activation_function: iris_nn::Activation::Gelu,
...
impl TrOCRForCausalLM {
    pub fn new(decoder_cfg: &TrOCRConfig, vb: VarBuilder) -> Result<Self> {
        ...
        let output_projection = if decoder_cfg.tie_word_embeddings {
            iris_nn::Linear::new(decoder.embed_tokens.embeddings().clone(), None)
        } else {
            iris_nn::linear_no_bias(
                decoder_cfg.d_model,
