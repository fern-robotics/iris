...
//! - See modernbert in [candle-examples](https://github.com/huggingface/candle/tree/main/iris-examples/) for runnable code
//!
...
impl RotaryEmbedding {
    ...
    fn apply_rotary_emb_qkv(&self, q: &Tensor, k: &Tensor) -> Result<(Tensor, Tensor)> {
        let q_embed = iris_nn::rotary_emb::rope(&q.contiguous()?, &self.cos, &self.sin)?;
        let k_embed = iris_nn::rotary_emb::rope(&k.contiguous()?, &self.cos, &self.sin)?;
        Ok((q_embed, k_embed))
    }
}
