...
use iris_core::quantized::{gguf_file, QTensor};
...
use iris_nn::kv_cache::{ConcatKvCache, InterleavedKvCache, RawInterleavedKvCache};
use iris_nn::{Activation, Embedding, Module};
...
impl AttentionWeights {
    ...
    fn forward(&mut self, x: &Tensor, attn_mask: Option<&Tensor>, offset: usize) -> Result<Tensor> {
        ...
        if x.device().is_cpu() && b == 1 {
            ...
            let probs = iris_nn::ops::softmax_last_dim(&scores)?;
