...
pub struct PromptEncoder {
    ...
    point_embeddings: Vec<iris_nn::Embedding>,
    not_a_point_embed: iris_nn::Embedding,
    mask_downscaling_conv1: iris_nn::Conv2d,
    mask_downscaling_ln1: super::LayerNorm2d,
    mask_downscaling_conv2: iris_nn::Conv2d,
    mask_downscaling_ln2: super::LayerNorm2d,
    mask_downscaling_conv3: iris_nn::Conv2d,
    no_mask_embed: iris_nn::Embedding,
...
impl PromptEncoder {
    pub fn new(
        ...
        let not_a_point_embed = iris_nn::embedding(1, embed_dim, vb.pp("not_a_point_embed"))?;
        let no_mask_embed = iris_nn::embedding(1, embed_dim, vb.pp("no_mask_embed"))?;
        let cfg = iris_nn::Conv2dConfig {
            stride: 2,
            ..Default::default()
        };
        let mask_downscaling_conv1 =
            iris_nn::conv2d(1, mask_in_chans / 4, 2, cfg, vb.pp("mask_downscaling.0"))?;
        let mask_downscaling_conv2 = iris_nn::conv2d(
            mask_in_chans / 4,
            mask_in_chans,
            2,
            cfg,
        ...
        let mask_downscaling_conv3 = iris_nn::conv2d(
            mask_in_chans,
            embed_dim,
            1,
            Default::default(),
        ...
        for i in 0..num_points_embeddings {
            let emb = iris_nn::embedding(1, embed_dim, vb_e.pp(i))?;
