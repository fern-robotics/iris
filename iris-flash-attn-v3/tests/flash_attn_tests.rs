...
fn flash_attn_acausal() -> Result<()> {
    ...
    let ys2 = {
        ...
        iris_flash_attn_v3::flash_attn(&q, &k, &v, 0.5, false, false)?.transpose(1, 2)?
    };
...
fn flash_attn_acausal_gqa() -> Result<()> {
    ...
    let ys2 = {
        ...
        iris_flash_attn_v3::flash_attn(&q, &k_gqa, &v_gqa, 0.125, false, true)?.transpose(1, 2)?
    };
    let ys2 = ys2.i(0)?.to_dtype(DType::F32)?;
...
fn flash_attn_varlen() -> Result<()> {
    ...
    let ys = {
        ...
        iris_flash_attn_v3::flash_attn_varlen(
