...
impl Tensor {
    ...
    ///
    /// ```rust
    /// use iris_core::{Tensor, Device, Shape};
    ...
    /// let tensor = tensor.to_dtype(iris_core::DType::F32)?;
    ...
    ///
    /// ```rust
    /// # use iris_core::{Tensor, DType, Device, D};
    /// let a = Tensor::zeros((2, 3), DType::F32, &Device::Cpu)?;
    ///
    /// let c = a.reshape((1, 6))?;
