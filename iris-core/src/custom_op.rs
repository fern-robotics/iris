...
pub struct UgIOp1 {
    ...
    #[cfg(feature = "metal")]
    func: iris_metal_kernels::metal::ComputePipeline,
}
...
impl UgIOp1 {
    ...
    pub fn new(
        name: &'static str,
        kernel: iris_ug::lang::ssa::Kernel,
        device: &crate::Device,
    ) -> Result<Self> {
        #[cfg(feature = "cuda")]
        {
...
impl InplaceOp1 for UgIOp1 {
    ...
    fn metal_fwd(&self, sto: &mut MetalStorage, layout: &Layout) -> Result<()> {
        ...
        iris_metal_kernels::debug_group!(encoder, "{}", self.name);
        ...
        let group_dims = iris_metal_kernels::utils::get_block_dims(b, 1, 1);
        let encoder: &iris_metal_kernels::metal::ComputeCommandEncoder = encoder.as_ref();
