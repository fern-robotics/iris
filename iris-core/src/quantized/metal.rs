...
use iris_metal_kernels::metal::Buffer;
use std::sync::Arc;
...
impl QMetalStorage {
    ...
    pub fn embedding(
        ...
        iris_metal_kernels::call_quantized_get_rows(
            device.device(),
            &encoder,
            device.kernels(),
            self.dtype.into(),
    ...
    fn fwd_mv(
        ...
        for batch_id in 0..m {
            iris_metal_kernels::call_quantized_matmul_mv_t(
                device.device(),
                &encoder,
                device.kernels(),
                self.dtype.into(),
    ...
    pub fn fwd(
        ...
        iris_metal_kernels::call_quantized_matmul_mm_t(
            device.device(),
            &encoder,
            device.kernels(),
            self.dtype.into(),
...
impl From<GgmlDType> for iris_metal_kernels::GgmlDType {
    fn from(value: GgmlDType) -> Self {
        match value {
            GgmlDType::Q4_0 => iris_metal_kernels::GgmlDType::Q4_0,
            GgmlDType::Q4_1 => iris_metal_kernels::GgmlDType::Q4_1,
            GgmlDType::Q5_0 => iris_metal_kernels::GgmlDType::Q5_0,
            GgmlDType::Q5_1 => iris_metal_kernels::GgmlDType::Q5_1,
            GgmlDType::Q8_0 => iris_metal_kernels::GgmlDType::Q8_0,
            GgmlDType::Q8_1 => iris_metal_kernels::GgmlDType::Q8_1,
            GgmlDType::Q2K => iris_metal_kernels::GgmlDType::Q2K,
            GgmlDType::Q3K => iris_metal_kernels::GgmlDType::Q3K,
            GgmlDType::Q4K => iris_metal_kernels::GgmlDType::Q4K,
            GgmlDType::Q5K => iris_metal_kernels::GgmlDType::Q5K,
            GgmlDType::Q6K => iris_metal_kernels::GgmlDType::Q6K,
            GgmlDType::Q8K => iris_metal_kernels::GgmlDType::Q8K,
            GgmlDType::F16 => iris_metal_kernels::GgmlDType::F16,
            GgmlDType::F32 => iris_metal_kernels::GgmlDType::F32,
            GgmlDType::BF16 => iris_metal_kernels::GgmlDType::BF16,
        }
    }
}
