use iris_wasm_example_yolo::coco_classes;
use iris_wasm_example_yolo::model::Bbox;
use iris_wasm_example_yolo::worker::Model as M;
use iris_wasm_example_yolo::worker::ModelPose as P;
