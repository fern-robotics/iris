...
use iris_wasm_chat_template::{ChatTemplate, ChatTemplateOptions, Conversation, Message};
use js_sys::Date;
use std::io::Cursor;
...
use iris_transformers::models::quantized_qwen3::ModelWeights as QuantizedQwen3;
...
impl Model {
    ...
    fn process_generation(&mut self, token_to_process: u32) -> iris_core::Result<String> {
