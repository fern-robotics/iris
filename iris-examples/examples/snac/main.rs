...
use iris_transformers::models::snac::{Config, Model};
...
fn main() -> Result<()> {
        ...
        Action::AudioToCode | Action::AudioToAudio => {
            let pcm = if args.in_file == "-" {
                ...
                if sample_rate != model_sample_rate {
                    ...
                    iris_examples::audio::resample(&pcm, sample_rate, model_sample_rate)?
                } else {
                    pcm
                }
            };
    ...
    match args.action {
        Action::AudioToCode => {
            ...
            iris_core::safetensors::save(&tensors, "codes.safetensors")?;
        }
        Action::AudioToAudio | Action::CodeToAudio => {
            ...
            let pcm = pcm.i(0)?.i(0)?;
            let pcm = iris_examples::audio::normalize_loudness(&pcm, model_sample_rate, true)?;
            ...
            if args.out_file == "-" {
                ...
                iris_examples::wav::write_pcm_as_wav(&mut output, &pcm, model_sample_rate)?;
            }
        }
    }
    Ok(())
