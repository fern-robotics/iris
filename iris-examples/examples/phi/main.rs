...
use iris_transformers::models::mixformer::{Config, MixFormerSequentialForCausalLM as MixFormer};
use iris_transformers::models::phi::{Config as PhiConfig, Model as Phi};
use iris_transformers::models::phi3::{Config as Phi3Config, Model as Phi3};
use iris_transformers::models::quantized_mixformer::MixFormerSequentialForCausalLM as QMixFormer;

use iris_core::{DType, Device, IndexOp, Tensor};
        ...
        None => {
            if args.quantized {
                ...
                match args.model {
                    ...
                    | WhichModel::V3
                    | WhichModel::V3Medium
                    | WhichModel::V4Mini => iris_examples::hub_load_safetensors(
                        &repo,
