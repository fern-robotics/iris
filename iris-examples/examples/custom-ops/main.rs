...
use iris_core::{CpuStorage, CustomOp1, Layout, Result, Shape, Tensor};
...
impl CustomOp1 for LayerNorm {
    ...
    fn cuda_fwd(
        ...
        use iris_core::cuda_backend::cudarc::driver::{LaunchConfig, PushKernelArg};
        ...
        builder.arg(&dst);
        builder.arg(&slice);
        iris_core::builder_arg!(builder, self.eps, d1, d2);
        unsafe { builder.launch(cfg) }.w()?;

        let dst = iris_core::CudaStorage::wrap_cuda_slice(dst, dev);
