...
use iris_examples::chat_template::{ChatTemplate, ChatTemplateOptions, Message};
...
use iris_transformers::models::smol::quantized_smollm3::QuantizedModelForCausalLM;
use iris_transformers::models::smol::smollm3::{Config, ModelForCausalLM};
...
fn main() -> Result<()> {
    ...
    let device = iris_examples::device(false)?;
