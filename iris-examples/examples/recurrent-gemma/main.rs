...
use iris_transformers::models::quantized_recurrent_gemma::Model as QModel;
use iris_transformers::models::recurrent_gemma::{Config, Model as BModel};
...
impl Model {
    fn forward(&mut self, xs: &Tensor, pos: usize) -> iris_core::Result<Tensor> {
        match self {
...
impl TextGeneration {
    ...
    fn new(
        ...
        let sampling = match temp {
            None => iris_transformers::generation::Sampling::ArgMax,
            Some(temperature) => match top_p {
                None => iris_transformers::generation::Sampling::TopK {
                    temperature,
                    k: top_k,
                },
                Some(top_p) => iris_transformers::generation::Sampling::TopKThenTopP {
                    temperature,
                    k: top_k,
                    p: top_p,
                },
