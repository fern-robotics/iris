...
use iris_transformers::models::parler_tts::{Config, Model};
...
fn main() -> anyhow::Result<()> {
    ...
    let lp = iris_transformers::generation::LogitsProcessor::new(
        args.seed,
    ...
    iris_examples::wav::write_pcm_as_wav(&mut output, &pcm, config.audio_encoder.sampling_rate)?;
