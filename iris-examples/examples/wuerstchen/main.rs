...
use iris_transformers::models::stable_diffusion;
use iris_transformers::models::wuerstchen;
...
fn run(args: Args) -> Result<()> {
    ...
    let image_embeddings = {
        ...
        let prior = {
            ...
            let vb = unsafe {
                iris_nn::VarBuilder::from_mmaped_safetensors(&[file], DType::F32, &device)?
            };
    ...
    for idx in 0..num_samples {
        ...
        iris_examples::save_image(&image, image_filename)?
    }
    Ok(())
}
