...
use iris_transformers::models::glm4::{Config as ConfigOld, EosTokenId, Model as ModelOld};
use iris_transformers::models::glm4_new::{Config as ConfigNew, ModelForCausalLM as ModelNew};
...
impl Model {
    fn forward(&mut self, input_ids: &Tensor, pos: usize) -> iris_core::Result<Tensor> {
        match self {
...
fn main() -> anyhow::Result<()> {
    ...
    let filenames = match &args.weight_path {
        ...
        _ => iris_examples::hub_load_safetensors(&repo, "model.safetensors.index.json")?,
    };
