...
use iris_transformers::models::jina_bert::{BertModel, Config, PositionEmbeddingType};

use anyhow::Error as E;
use iris_core::{DType, Module, Tensor};
...
pub fn normalize_l2(v: &Tensor) -> iris_core::Result<Tensor> {
