...
use iris_transformers::models::mpt::{Config, Model as M};
use iris_transformers::models::quantized_mpt::Model as Q;
...
impl Model {
    fn forward(&mut self, xs: &Tensor) -> iris_core::Result<Tensor> {
        match self {
