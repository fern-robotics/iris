...
use iris_transformers::models::quantized_llama::ModelWeights as Phi3b;
use iris_transformers::models::quantized_phi::ModelWeights as Phi2;
use iris_transformers::models::quantized_phi3::ModelWeights as Phi3;
