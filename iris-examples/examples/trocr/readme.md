...
```bash
cargo run --example trocr --release -- --image iris-examples/examples/trocr/assets/trocr.png
cargo run --example trocr --release -- --which large --image iris-examples/examples/trocr/assets/trocr.png
cargo run --example trocr --release -- --which base-printed --image iris-examples/examples/trocr/assets/noto.png
cargo run --example trocr --release -- --which large-printed --image iris-examples/examples/trocr/assets/noto.png
```
