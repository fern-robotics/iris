...
use iris_transformers::models::dinov2reg4;
...
pub fn main() -> anyhow::Result<()> {
    ...
    let image = iris_examples::imagenet::load_image518(args.image)?.to_device(&device)?;
    println!("loaded image {image:?}");

    let f_species_id_mapping = "iris-examples/examples/dinov2reg4/species_id_mapping.txt";
