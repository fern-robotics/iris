...
fn main() -> anyhow::Result<()> {
    ...
    iris_core::cuda::set_gemm_reduced_precision_f16(true);
    iris_core::cuda::set_gemm_reduced_precision_bf16(true);
    ...
    for prompt_index in 0.. {
        ...
        if let Some(rest) = tos.decode_rest().map_err(iris_core::Error::msg)? {
            print!("{rest}");
        }
        std::io::stdout().flush()?;
